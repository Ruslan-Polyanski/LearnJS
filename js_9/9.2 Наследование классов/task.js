...
() => {
  ...
  // Не изменяйте класс clock, расширьте его.
  ...
  class ExtendedClock extends Clock {
    constructor({ template, precision }) {
      super({ template })
      this.precision = precision === undefined ? 1000 : precision;
    }
  ...
  const extendedClock = new ExtendedClock({template: 'h:m:s', precision: 3000});
  extendedClock.start()
